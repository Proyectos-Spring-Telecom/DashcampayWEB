...
export const appConfig = {
    providers: [
        importProvidersFrom(BrowserModule, MatDialogModule, MatBottomSheetModule, MatNativeDateModule, BrowserAnimationsModule, MatIconModule // ✅ NUEVO
        ),
        ...
        provideAnimations(),
        provideHttpClient(withInterceptors([interceptServiceInterceptor]) // ✅ CORRECTO
        ),
        provideVex({
