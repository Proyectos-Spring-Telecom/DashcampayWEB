...
ComponentsOverviewButtonGroupComponent = __decorate([
    Component({
...
export { ComponentsOverviewButtonGroupComponent };
//# sourceMappingURL=components-overview-button-group.component.js.map