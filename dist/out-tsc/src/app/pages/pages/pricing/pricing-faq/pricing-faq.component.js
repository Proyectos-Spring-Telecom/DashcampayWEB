...
let PricingFaqComponent = class PricingFaqComponent {
    constructor() {
        this.items = [
            {
...
PricingFaqComponent = __decorate([
    Component({
...
export { PricingFaqComponent };
//# sourceMappingURL=pricing-faq.component.js.map