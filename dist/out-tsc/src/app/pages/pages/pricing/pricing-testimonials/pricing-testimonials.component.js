...
let PricingTestimonialsComponent = class PricingTestimonialsComponent {
    constructor() {
        this.items = [
            {
...
PricingTestimonialsComponent = __decorate([
    Component({
...
export { PricingTestimonialsComponent };
//# sourceMappingURL=pricing-testimonials.component.js.map