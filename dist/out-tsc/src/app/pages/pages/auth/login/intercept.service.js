...
export const SKIP_APP_AUTH = new HttpContextToken(() => false);
...
export function withSkipAuth(ctx = new HttpContext()) {
    return ctx.set(SKIP_APP_AUTH, true);
}
export const interceptServiceInterceptor = (req, next) => {
