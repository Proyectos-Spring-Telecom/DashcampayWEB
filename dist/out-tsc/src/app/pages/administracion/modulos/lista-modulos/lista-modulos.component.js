...
let ListaModulosComponent = class ListaModulosComponent {
    constructor(route, moduloService, alerts) {
        this.route = route;
...
], ListaModulosComponent.prototype, "dataGrid", void 0);
ListaModulosComponent = __decorate([
    Component({
...
export { ListaModulosComponent };
//# sourceMappingURL=lista-modulos.component.js.map