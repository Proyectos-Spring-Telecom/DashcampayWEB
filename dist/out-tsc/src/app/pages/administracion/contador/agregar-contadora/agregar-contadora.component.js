...
let AgregarContadoraComponent = class AgregarContadoraComponent {
    get isAdmin() { return this.idRolUser === 1; }
    constructor(route, fb, dispoBlueService, activatedRouted, clieService, users, alerts) {
        this.route = route;
        this.fb = fb;
        this.dispoBlueService = dispoBlueService;
    ...
    obtenerDispositivoID() {
        this.dispoBlueService.obtenerDispositivoBlue(this.idContadora).subscribe((response) => {
...
AgregarContadoraComponent = __decorate([
    Component({
...
], AgregarContadoraComponent);
export { AgregarContadoraComponent };
//# sourceMappingURL=agregar-contadora.component.js.map