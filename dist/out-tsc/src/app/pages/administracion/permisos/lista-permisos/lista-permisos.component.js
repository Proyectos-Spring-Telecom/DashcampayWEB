...
let ListaPermisosComponent = class ListaPermisosComponent {
    constructor(permService, route, alerts) {
    ...
    setupDataSource() {
        ...
        this.listaPermisos = new CustomStore({
            ...
            load: async (loadOptions) => {
                ...
                try {
                    const resp = await lastValueFrom(this.permService.obtenerPermisosData(page, take));
                    this.loading = false;
    ...
    onGridOptionChanged(e) {
        ...
        const dataFiltrada = (this.paginaActualData || []).filter((row) => {
            ...
            const estHits = normalizar(estText).includes(q) ||
...
], ListaPermisosComponent.prototype, "dataGrid", void 0);
ListaPermisosComponent = __decorate([
    Component({
...
export { ListaPermisosComponent };
//# sourceMappingURL=lista-permisos.component.js.map