...
let AgregarTransaccionComponent = class AgregarTransaccionComponent {
    constructor(fb, route, transaccionService, dispService, moneService, zone, alerts) {
        this.fb = fb;
        this.route = route;
        ...
        this.listaMonederos = [];
        this.title = 'Generar Transacción';
        ...
        this.lat = null;
        this.lng = null;
        this.POLANCO = { lat: 19.4326, lng: -99.2000 };
    }
    ngOnInit() {
    ...
    obtenerDispositivos() {
        this.dispService.obtenerDispositivos().subscribe((response) => {
            this.listaDispositivos = (response?.data || []).map((d) => ({
                ...d,
    ...
    initMapForModal() {
        ...
        if (hasInit) {
            const pos = { lat: latInit, lng: lngInit };
    ...
    localDatetimeToOffsetISO(localStr) {
        if (!localStr)
            return null;
...
__decorate([
    Input()
], AgregarTransaccionComponent.prototype, "modalOpen", void 0);
__decorate([
    Input()
], AgregarTransaccionComponent.prototype, "modalClosing", void 0);
__decorate([
    Input()
], AgregarTransaccionComponent.prototype, "modalAnim", void 0);
AgregarTransaccionComponent = __decorate([
    Component({
...
export { AgregarTransaccionComponent };
//# sourceMappingURL=agregar-transaccion.component.js.map