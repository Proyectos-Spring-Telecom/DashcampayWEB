...
let AgregarPasajeroComponent = class AgregarPasajeroComponent {
    constructor(fb, pasajService, activatedRouted, router, alerts) {
        this.fb = fb;
    ...
    obtenerPasajeroID() {
        this.pasajService.obtenerPasajero(this.idPasajero).subscribe((response) => {
    ...
    onDocumentoDragOver(event) {
        event.preventDefault();
        event.stopPropagation();
        this.documentoDragging = true;
    }
    onDocumentoDragLeave(event) {
        event.preventDefault();
        event.stopPropagation();
        this.documentoDragging = false;
    }
    onDocumentoDrop(event) {
        event.preventDefault();
        event.stopPropagation();
        this.documentoDragging = false;
    ...
    openDocumentoFilePicker() {
        const fileInput = document.getElementById('documentacion-file');
        if (fileInput)
            fileInput.click();
    }
    onDocumentoFileSelected(event) {
...
AgregarPasajeroComponent = __decorate([
    Component({
...
export { AgregarPasajeroComponent };
//# sourceMappingURL=agregar-pasajero.component.js.map