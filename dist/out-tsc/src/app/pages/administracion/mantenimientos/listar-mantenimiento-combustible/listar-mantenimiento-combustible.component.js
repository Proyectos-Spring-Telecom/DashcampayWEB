...
let ListarMantenimientoCombustibleComponent = class ListarMantenimientoCombustibleComponent {
    ...
    setupDataSource() {
        ...
        this.listaMantenimientos = new CustomStore({
            ...
            load: async (loadOptions) => {
                ...
                try {
                    const resp = await lastValueFrom(this.mantenimientosService.obtenerMantenimientoCombustibleData(page, take));
                    this.loading = false;
...
], ListarMantenimientoCombustibleComponent.prototype, "dataGrid", void 0);
ListarMantenimientoCombustibleComponent = __decorate([
    Component({
...
export { ListarMantenimientoCombustibleComponent };
//# sourceMappingURL=listar-mantenimiento-combustible.component.js.map